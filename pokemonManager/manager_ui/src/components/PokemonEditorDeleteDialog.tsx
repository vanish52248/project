...
export default function PokemonDeleteDialog(props: any) {
    ...
    const handleDelete = () => {
        ...
        axios.request({
            method: 'DELETE',
            url: process.env.REACT_APP_API_URL + 'v1/pokemon_delete/',
            params: { pokemon_id: props.currentPokemonId },
            headers: {
            ...
            .then(response => {
                props.setPokemonDeleteOpen(false);
                props.setOpenSnack(true);
                props.setSeverity("success");
                props.setMessage(`登録済みデータから ${props.currentPokemonName} が削除されました。`);
            })
            .catch(error => {
    ...
    return (
        <div>
            <Dialog
                ...
                open={props.setPokemonDeleteOpen}
                onClose={handleClose}
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>
                        登録データから {props.currentPokemonName} を削除しますか？
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
